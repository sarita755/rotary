                 ...
                 <div class="align-text14-cols">
                      ...
                      <div class="col-md-4">
                        <div class="text14-right">
                            <img src="{{asset('image/leadermessage/'.$leadermessage->image)}}" alt=""  class="img-responsive img-thumbnail img-fluid" style="height:380px width:100%;" />
                        ...
                        <p>{{  html_entity_decode(strip_tags($leadermessage->Message)) }}</td></p>
