@extends('front.layouts.sub')
  ...
  <div class="row">
            <div class="col-lg-6 col-lg-offset-3 text-center">  
                <h2 class="one"><span class="ion-minus"></span> Library<span class="ion-minus"></span></h2>
            </div> 
        </div> 
...
<button type="button" class="btn btn-default btn-block"><a href="{{$resource->file}}">Rotary Book</a></button>
