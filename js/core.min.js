 ...
 * @module navigation
 */
!function(n){"use strict";n.fn.menumaker=function(s){var e=n(this),a=n.extend({format:"dropdown",sticky:!1},s);return this.each(function(){n(this).find(".navbar-toggler").on("click",function(){n(this).toggleClass("menu-opened");var s=n(this).next("ul");s.hasClass("open")?s.slideToggle().removeClass("open"):(s.slideToggle().addClass("open"),"dropdown"===a.format&&s.find("ul").show())}),e.find(".navbar-nav li ul").parent().addClass("has-sub");"multitoggle"===a.format?(e.find(".has-sub").prepend('<span class="submenu-button"></span>'),e.find(".submenu-button").on("click",function(){n(this).toggleClass("submenu-opened"),n(this).siblings("ul").hasClass("open")?(n(this).siblings("ul").removeClass("open").slideToggle(),n(this).parent("li").removeClass("active")):(n(this).siblings("ul").addClass("open").slideToggle(),n(this).parent("li").addClass("active"))})):e.addClass("dropdown"),!0===a.sticky&&e.css("position","fixed");var s=function(){n(window).width()>991&&e.find("ul").show()};return s(),n(window).on("resize",s)})},n(document).ready(function(){n("nav").menumaker({format:"multitoggle"});var s=window.location.pathname.split("/"),e=window.location.pathname;e=s[s.length-1].length>0?s[s.length-1]:s[s.length-2],n(".navbar-nav li").find('a[href="'+e+'"]').closest("li").addClass("active").parents().eq(1).addClass("current"),n(".navbar-nav li").find('a[href="'+e+'"]').closest("li").addClass("active").parents().eq(3).addClass("current")}),n(".navbar-default .attr-nav").each(function(){n("li.search > a",this).on("click",function(s){s.preventDefault(),n(".top-search").slideToggle()})}),n(".input-group-addon.close-search").on("click",function(){n(".top-search").slideUp()})}(jQuery);
...
/**
 * @module jquery.counterup.js
 * @version 1.0
 * @author Benjamin Intal http://gambit.ph @bfintal
 ...
 * @module Stellar.js
 * @version 6.2
 * @author Mark Dalgleish | http://markdalgleish.com/projects/stellar.js | http://markdalgleish.mit-license.org
 */
...
/**
 * @module Tabslet | tabs jQuery plugin
 * @version 1.7.3
 ...
 * @version 3.0.4
 * @license Licensed GPLv3 for open source use or Isotope Commercial License for commercial use
 ...
 */
(function($){"use strict";$('.switcher-setting').on('click',function(){if($('#style-switcher').hasClass('active')){$('#style-switcher').removeClass('active');}else{$('#style-switcher').removeClass('active');$('#style-switcher').addClass('active');}});$('.boxed,.pattren-wrap a').on('click',function(){$('.main-wrapper').addClass('wrapper-boxed');$('.main-wrapper').removeClass('wrapper-wide');$(window).resize();});$('.wide').on('click',function(){$('.main-wrapper').addClass('wrapper-wide');$('.main-wrapper').removeClass('wrapper-boxed');$(window).resize();});$('.bg-list li a').on('click',function(){var bg=$(this).css("backgroundImage");$("body").css("backgroundImage",bg);$(window).resize();});$(".style1").on("click",function(){$("#colors").attr("href","css/styles.css");$("#logo").attr("src","img/logos/logo-color-01.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");return false;});$(".style2").on("click",function(){$("#colors").attr("href","css/styles-2.css");$("#logo").attr("src","img/logos/logo-color-02.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");return false;});$(".style3").on("click",function(){$("#colors").attr("href","css/styles-3.css");$("#logo").attr("src","img/logos/logo-color-03.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");return false;});$(".style4").on("click",function(){$("#colors").attr("href","css/styles-4.css");$("#logo").attr("src","img/logos/logo-color-04.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");return false;});$(".style5").on("click",function(){$("#colors").attr("href","css/styles-5.css");$("#logo").attr("src","img/logos/logo-color-05.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");return false;});$(".style6").on("click",function(){$("#colors").attr("href","css/styles-6.css");$("#logo").attr("src","img/logos/logo-color-06.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");return false;});$(".style7").on("click",function(){$("#colors").attr("href","css/styles-7.css");$("#logo").attr("src","img/logos/logo-color-07.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");return false;});$(".style8").on("click",function(){$("#colors").attr("href","css/styles-8.css");$("#logo").attr("src","img/logos/logo-color-08.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");return false;});})(jQuery);